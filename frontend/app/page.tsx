...
export default function NexusApp() {
  ...
  const handleGoogleSuccess = async (credentialResponse: any) => {
    ...
    try {
      ...
      loginUser({ name: decoded.name, email: decoded.email, picture: decoded.picture, role: "Viewer" }); // Default to Viewer if backend check fails
    }
  };
  ...
  const handleSkipDev = () => {
    // Restricted Access for Skip Dev
